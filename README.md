...
* **Практическая реализация:** *
    *А. Кэлер, Г. Брэдски. «Изучаем OpenCV 3»*
    * Г. Гарсия,  О. Суареса и др.  «Обработка изображений с помощью OpenCV»*
    > Незаменимые руководства по эффективному использованию функций библиотеки и управлению структурами данных в C++.                
  
* **Проектирование GUI:** *
   *Jan Bodnar. «wxWidgets C++ tutorial» (ZetCode)*
   ...
   *Julian Smart and Kevin Hock with Stefan Csomor. «Cross-Platform GUI Programming with wxWidgets».*
