 ...
 *************************************************************
*/
#ifndef MEDIANBLURTESTFRAME_H
#define MEDIANBLURTESTFRAME_H
...
*/
class medianBlurTestFrame : public wxPanel
{
 public :
    medianBlurTestFrame(wxWindow* parent);
